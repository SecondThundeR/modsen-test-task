...
export function BookCard({ id, imageUrl, categories, title, authors }: BookCardProps) {
  ...
  return (
    <Link to={`/books/${id}`}>
      <div className="min-h-16 w-72 aspect-auto rounded-xl bg-base-200 flex flex-col gap-4 px-4 py-6 items-center duration-[350ms] ease-in-out hover:-translate-y-3 hover:drop-shadow-xl">
